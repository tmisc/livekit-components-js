...
import type { ParticipantClickEvent, TrackReferenceOrPlaceholder } from 'fork-livekit-components-core';
import { isParticipantSourcePinned, setupParticipantTile } from 'fork-livekit-components-core';
